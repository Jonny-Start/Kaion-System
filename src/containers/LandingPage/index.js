                        ...
                        <div className="contentCardPrice">
                            ...
                            <div className="contentDescriptionCard">
                                ...
                                <span className="descriptionPlan">
                                    <p>  <i className="fa-sharp fa-solid fa-list-check"></i> un proyecto</p>
                                    <p> <i className="fa-solid fa-users"></i> 2 empleados</p>
                                    <p><i className="fa-solid fa-chart-simple"></i> No muestra gráficas</p>
                                </span>
                            </div>
                ...
                <footer>
                    <div id="contentFooter">
                        <span id="descriptionFooter">
                            <h4 id="h4DescriptionFooter"> Contando las horas de trabajo para alcanzar el éxito. </h4>
                        </span>
                        <span id="titleFooter">
